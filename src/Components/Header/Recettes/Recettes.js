...
// export default function Recettes({ title, calories, image, ingredients }) {
//   return (
...
const Recettes = () => {
  ...
  return (
    <div className='App'>
      ...
      <div className='navbar'>
        <form onSubmit={getSearch} className='search-form'>
          <select className='dropdown' id='health'>
            ...
            <option value='sugar-conscious'> Low Sugar </option>
      ...
      <div id='head'>
        <h1 className='heading'>{capitalize(Query)} </h1>
